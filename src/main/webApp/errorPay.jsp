...
<div id="wrapper">
    ...
    <p style="font-size: 25pt; " align="center">Вы не можете совершить операцию пока не пройдете авторизацию</p>
    <p style="font-size: 20pt; " align="center"><a href="cart.jsp">Вернуться в корзину</a></p>
    <p style="font-size: 20pt; " align="center"><a href="./loginServlet">Авторизация</a></p>
</div>
</body>
</html>